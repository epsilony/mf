...
public class LevelSetApproximationAssemblerTest {
    ...
    //
    // @Override
    // public double[] valuesByDistanceSquare(double distanceSquare, double[]
    // results) {
    ...
    // double[] lagrangeShapeFuncWithNormalSort = new double[]{0, 0, 14, 0, 17,
    // 0};
    //
    // @Test
    ...
    // double wholeWeight = weight *
    // radialFunctionCore.valuesByDistance(load[0], null)[0];
    ...
    // * wholeWeight * load[0]);
    // }
    // for (int i = shapeFunctionWithNormalSort.length; i < getMatrixSize();
    // i++) {
    // expMat.set(i, i, 1);
    // }
    //
    ...
    // result.set(i + shapeFunctionWithNormalSort.length,
    // lagrangeShapeFuncWithNormalSort[i]);
    // }
    // return result;
    // }
    //
    // private int getMatrixSize() {
    // return shapeFunctionWithNormalSort.length +
    // lagrangeShapeFuncWithNormalSort.length;
    // }
    //
    ...
    // for (int i : lagIndes) {
    // lagFunc.add(lagrangeShapeFuncWithNormalSort[i -
    // shapeFunctionWithNormalSort.length]);
    // }
    //
    ...
    // assembler.setLagrangeShapeFunctionValue(new TIntArrayList(lagIndes),
    // lagFunc.toArray());

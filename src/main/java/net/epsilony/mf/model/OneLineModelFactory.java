...
public class OneLineModelFactory implements Factory<AnalysisModel> {
    ...
    public AnalysisModel produce() {
        ...
        rawPhysicalModel.setDimension(oneLinePhM.getDimension());
        rawPhysicalModel.setGeomRoot(line);
        ...
        rawPhysicalModel.setVolumeLoad(oneLinePhM.getVolumeLoad());

        RawAnalysisModel result = new RawAnalysisModel();
        result.setFractionizedModel(rawPhysicalModel);
        return result;
    }

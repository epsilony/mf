 ...
 * 
 */
public class TwoDPoissonContextFactory extends ProcessContextFactory {
    @Override
    protected void modifyContext() {
        context.register(TwoDPoissonConf.class);
    }

    public static void main(String[] args) {
        double subDomainSize = 0.025;
        ...
        analysisModelFactory.setSpaceNodesDisturbRatio(0.4);
        AnalysisModel analysisModel = analysisModelFactory.produce();

        TwoDPoissonContextFactory contextFactory = new TwoDPoissonContextFactory();
